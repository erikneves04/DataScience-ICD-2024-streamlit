...
if selected == "Análise Exploratória":
    ...
    # Cria duas colunas
    col1, col2 = st.columns([2, 3])  # Ajuste os números para alterar a proporção entre as colunas
    
    with col1:
        st.write("Conteúdo na coluna da esquerda...")
    
    with col2:
        st.write("Conteúdo na coluna da direita...")
        # Adicione mais elementos aqui como gráficos, tabelas, etc.
